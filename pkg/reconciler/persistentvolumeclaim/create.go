...
// Create it allows the consumer to create a PVC in an imperative way.
// Deprecated: this is exported for legacy reason
func Create(
	ctx context.Context,
	c client.Client,
	...
	return create(ctx, c, cluster, configuration)
}
