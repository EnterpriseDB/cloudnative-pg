...
var _ = Describe("Postgres Major Upgrade", Label(tests.LabelPostgresMajorUpgrade), func() {
	...
	var generateBaseCluster = func(namespace string, storageClass string) *v1.Cluster {
		return &v1.Cluster{
	...
	var generatePostgreSQLCluster = func(namespace string, storageClass string, majorVersion int) *v1.Cluster {
	...
	var generatePostgreSQLMinimalCluster = func(namespace string, storageClass string, majorVersion int) *v1.Cluster {
	...
	var generatePostGISCluster = func(namespace string, storageClass string, majorVersion int) *v1.Cluster {
		cluster := generateBaseCluster(namespace, storageClass)
